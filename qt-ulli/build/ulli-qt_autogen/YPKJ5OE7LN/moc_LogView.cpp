...
namespace {
struct qt_meta_tag_ZN4ulli2ui7LogViewE_t {};
} // unnamed namespace

template <> constexpr inline auto ulli::ui::LogView::qt_create_metaobjectdata<qt_meta_tag_ZN4ulli2ui7LogViewE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'onAppended'
        QtMocHelpers::SlotData<void(QString, core::ProgressLog::Severity, QString)>(1, 2, QMC::AccessPrivate, QMetaType::Void, {{
    ...
    return QtMocHelpers::metaObjectData<LogView, qt_meta_tag_ZN4ulli2ui7LogViewE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject ulli::ui::LogView::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN4ulli2ui7LogViewE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN4ulli2ui7LogViewE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN4ulli2ui7LogViewE_t>.metaTypes,
    nullptr
} };
...
void *ulli::ui::LogView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN4ulli2ui7LogViewE_t>.strings))
