...
const std::vector<Distro>& Catalog::fallbackDistros() {
    static const std::vector<Distro> kFallback = {
        ...
        {"ubuntu", "Ubuntu 24.04.4 LTS", "ubuntu-24.04.4-desktop-amd64.iso",
         ...
         "casper/vmlinuz"},
        {"kubuntu", "Kubuntu 24.04.4 LTS", "kubuntu-24.04.4-desktop-amd64.iso",
         "02cda2568cb96c090b0438a31a7d2e7b07357fde16217c215e7c3f45263bcc49",
